...
Para usar este material, navegue pelas seções de acordo com sua função no projeto, siga os checklists como guia durante seu trabalho, consulte as referências para entender os critérios técnicos e compartilhe com a equipe para criar uma cultura de acessibilidade. Juntos, podemos construir uma web mais inclusiva para todos.
